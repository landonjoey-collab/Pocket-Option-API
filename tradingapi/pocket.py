"""
WebSocket client for communication with TradingAPI.
"""
from tradingapi.backend.ws.client import WebSocketClient
from tradingapi.backend.ws.chat import WebSocketClientChat
...
class TradingApiClient:
    ...
    def connect(self):
        ...
        try:
            self.websocket_thread = threading.Thread(target=self.websocket_client.ws.run_forever, kwargs={
                ...
                "origin": "https://trading-platform.com",
    ...
    def send_websocket_request(self, msg):
        """Send websocket request to TradingAPI server.
